...
function analyzePrompt(prompt) {
  ...
  // Mood detection
  if (
    lowerPrompt.includes("happy") ||
    lowerPrompt.includes("uplifting") ||
    lowerPrompt.includes("cheerful")
  ) {
    analysis.mood = "happy";
    ...
    lowerPrompt.includes("melancholic") ||
  ...
  if (position % 4 === 0) {
    ...
    scalePosition =
      analysis.chordProgression[
        Math.floor(position / 4) % analysis.chordProgression.length
      ];
  }
